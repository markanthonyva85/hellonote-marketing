# HelloNote Agent Brief
Read this file FIRST in any new Claude chat before doing any HelloNote marketing, design, content, or development work. This is the single source of truth for all AI agents working on HelloNote.

---

## What is HelloNote
All-in-one EMR, billing, scheduling, and documentation platform built by therapists for therapists.
Disciplines: PT, OT, SLP, Chiropractic (DC)
Pricing: Free $0 | Lite $49.99/mo | Plus $70/mo
No setup fees. No contracts. Cancel anytime. HIPAA compliant.
2,000+ practices. $2M ARR.
...
5. The specific persona prompt for the task
...
| Task | Agent | File |
|------|-------|------|
| ICD-10 pages, CPT guides, blog posts | Jordan Mills | 02-prompts/jordan-mills-prompt.md |
| Logo, branding, visual identity | Atlas | 02-prompts/atlas-logo-branding-prompt.md |
| Website development, SEO architecture | Alex Chen | 02-prompts/alex-chen-prompt.md |
| Ads, emails, social posts, landing pages | Buyer Personas | 02-prompts/hellonote-buyer-personas.md |
| Any task | Brand Guide | 02-prompts/hellonote-brand-guide.md |
...
## How to Start Any New Chat

Paste this into any new Claude chat:
"Read github.com/markanthonyva85/hellonote-marketing/AGENT_BRIEF.md then [your task]"

For design tasks add:
"and github.com/markanthonyva85/hellonote-marketing/02-prompts/hellonote-brand-guide.md"

For content tasks add:
"and github.com/markanthonyva85/hellonote-marketing/02-prompts/jordan-mills-prompt.md"

For marketing copy add:
"and github.com/markanthonyva85/hellonote-marketing/02-prompts/hellonote-buyer-personas.md"
